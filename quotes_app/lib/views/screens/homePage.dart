          ...
          builder: (context) => CupertinoAlertDialog(
            ...
            actions: [
              CupertinoButton(
                  ...
                  child: Text(
                    "Yes",
                    style: TextStyle(color: MyColor.Theme1),
                  )),
              CupertinoButton(
                  onPressed: () {
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: MyColor.Theme2),
                        ),
                        child: Text(
                          "All",
                          style: TextStyle(
